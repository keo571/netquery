...
4. Use explicit JOIN syntax instead of implicit joins
5. Ensure the query is safe (SELECT only, no data modification)
6. Handle case-insensitive string matching with UPPER() or LOWER() when appropriate
7. For date operations in SQLite, use:
