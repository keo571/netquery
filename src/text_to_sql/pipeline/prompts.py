"""
Prompts for the Text-to-SQL pipeline.
...
# Template for comprehensive pipeline responses
PIPELINE_RESPONSE_TEMPLATE = """## Query Analysis
...
def format_pipeline_response(
    ...
    if include_technical_details:
        return PIPELINE_RESPONSE_TEMPLATE.format(
