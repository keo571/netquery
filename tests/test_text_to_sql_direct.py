#!/usr/bin/env python3
"""
Direct Text-to-SQL pipeline tests.
Tests SQL generation and execution capabilities directly via the text-to-SQL pipeline.
"""
import asyncio
...
from text_to_sql.pipeline.graph import text_to_sql_graph
...
async def run_tests():
    """Run all tests."""
    print_test_header("Starting Text-to-SQL Pipeline Tests")
